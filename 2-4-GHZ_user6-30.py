...
T_ENC   = 0.005   # 暗号化時間 (tenc) [秒]
D_PROP  = 0.0001  # 伝搬遅延 (dprop) [秒]
...
# ==========================================
def main():
    print("=== HAP-Alice: Scalability Simulation (Varying Users) ===")
    ...
    fixed_angle = 10    # 全員 天頂角10度に固定
    user_counts = range(6, 31, 6) # 6, 12, 18, 24, 30人
    ...
    for N_USERS in user_counts:
        ...
        for n_ghz in [2, 3, 4]:
            ...
            # （※出力が長くなるため、各グループの個別Base SKRの表示はコメントアウトや省略をしておくと見やすいかもしれません）
