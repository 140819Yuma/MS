...
# ==========================================
def main():
    print("=== HAP-Alice: Scalability Simulation (Optimized with GLOBAL_BACKEND) ===")
    
    NUM_TIMESLOTS = 500 
    fixed_angle = 0    
    user_counts = range(6, 31, 6) 

    start_time = time.time()

    for N_USERS in user_counts:
        print(f"\n[{'='*10} Number of Users = {N_USERS}, Zenith Angle = {fixed_angle} deg {'='*10}]")
        
        eta_matrix = generate_realistic_eta(N_USERS, NUM_TIMESLOTS, [fixed_angle] * N_USERS)
        eta_alice = 1.0
